...
function eventKrpanoLoaded () {
	...
	ktools.I18N.getInstance().initLanguage('en', crossDomainTargetUrl+'tourdata/tour_messages_','.xml');
	krpanoLoaded = true;
	...
	if(mapsApiLength > 0){
		...
		if (mapsApiLength > 1) {
			...
			if (mapsApiLength > 2) {
				...
				var mapstractionScript = new ktools.Script("maps_mapstraction", crossDomainTargetUrl+"tourdata/graphics/KolorMap/lib/mxn.js"+refreshIE, [mapApiScript3], false);
				var mapstractionScriptCore = new ktools.Script("maps_mapstraction_core", crossDomainTargetUrl+"tourdata/graphics/KolorMap/lib/mxn.core.js"+refreshIE, [mapstractionScript], false);
				var mapstractionScriptCoreLayer3 = new ktools.Script("maps_mapstraction_core_layer3", crossDomainTargetUrl+"tourdata/graphics/KolorMap/lib/"+mapApiOrder[2][3]+refreshIE, [mapstractionScriptCore], false);
				var mapstractionScriptCoreLayer2 = new ktools.Script("maps_mapstraction_core_layer2", crossDomainTargetUrl+"tourdata/graphics/KolorMap/lib/"+mapApiOrder[1][3]+refreshIE, [mapstractionScriptCoreLayer3], false);
				var mapstractionScriptCoreLayer1 = new ktools.Script("maps_mapstraction_core_layer1", crossDomainTargetUrl+"tourdata/graphics/KolorMap/lib/"+mapApiOrder[0][3]+refreshIE, [mapstractionScriptCoreLayer2], false);
			} else {
				var mapstractionScript = new ktools.Script("maps_mapstraction", crossDomainTargetUrl+"tourdata/graphics/KolorMap/lib/mxn.js"+refreshIE, [mapApiScript2], false);
				var mapstractionScriptCore = new ktools.Script("maps_mapstraction_core", crossDomainTargetUrl+"tourdata/graphics/KolorMap/lib/mxn.core.js"+refreshIE, [mapstractionScript], false);
				var mapstractionScriptCoreLayer2 = new ktools.Script("maps_mapstraction_core_layer2", crossDomainTargetUrl+"tourdata/graphics/KolorMap/lib/"+mapApiOrder[1][3]+refreshIE, [mapstractionScriptCore], false);
				var mapstractionScriptCoreLayer1 = new ktools.Script("maps_mapstraction_core_layer1", crossDomainTargetUrl+"tourdata/graphics/KolorMap/lib/"+mapApiOrder[0][3]+refreshIE, [mapstractionScriptCoreLayer2], false);
			}
		} else {
			var mapstractionScript = new ktools.Script("maps_mapstraction", crossDomainTargetUrl+"tourdata/graphics/KolorMap/lib/mxn.js"+refreshIE, [mapApiScript], false);
			var mapstractionScriptCore = new ktools.Script("maps_mapstraction_core", crossDomainTargetUrl+"tourdata/graphics/KolorMap/lib/mxn.core.js"+refreshIE, [mapstractionScript], false);
			var mapstractionScriptCoreLayer1 = new ktools.Script("maps_mapstraction_core_layer1", crossDomainTargetUrl+"tourdata/graphics/KolorMap/lib/"+mapApiOrder[0][3]+refreshIE, [mapstractionScriptCore], false);
		}
		
		var kolorMapScript = new ktools.Script("kolormap", crossDomainTargetUrl+"tourdata/graphics/KolorMap/js/KolorMap.min.js", [mapstractionScriptCoreLayer1], true);
...
function initKolorMapOnReady(pluginName, defaultMapLayer, mapAreaDiv) {
	...
	kolorMap.setGraphicsUrl(crossDomainTargetUrl+"tourdata/graphics/"+pluginName.toLowerCase()+"/");
